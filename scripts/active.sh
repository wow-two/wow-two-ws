...
#   active.sh drydock forever-pin      only the named projects (any flag still applies)
#   active.sh -h | --help
#
# Env:
...
PROJECTS=(
  ...
  "forever-pin|ventures/smart-qr-poc/engineering/codebase/smartqr.backend-services/smartqr.backend-services.slnx|ventures/smart-qr-poc/engineering/codebase/smartqr.frontend-services"
