...
- [entities.md](entities.md) — entity-specific doc rules
- [enums.md](enums.md) — enum value documentation
- [services.md](services.md) — service / client / factory naming
- [api-endpoints.md](api-endpoints.md) — query/command/handler docs
