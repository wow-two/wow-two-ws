...
> A vector representation converted into pixels.

## Location

### Folder
- must use `Rasterizers/` for a role folder under the domain that owns the capability.
...
- must start a concrete implementation with **Rasterizes**, naming the vector input and pixel output.
