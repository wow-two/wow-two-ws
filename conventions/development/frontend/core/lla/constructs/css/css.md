...
- stylesheet location and wiring belong to the deliverable:
  [app styling](../../../../shapes/app/platform/styling.md) or [library](../../../../shapes/library/library.md).
...
- **`<style>` in a Vue SFC, scoped or not** — use utilities under the house styling policy.
